  ...
  return (
    <main className="min-h-screen bg-black text-[#151515]">
      <div className="mx-auto min-h-screen w-full max-w-[430px] overflow-hidden bg-[#f7f2ea] pb-24 shadow-2xl">
        <section className="relative overflow-hidden rounded-b-[30px] bg-black px-5 pb-5 pt-5 text-white">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between gap-3">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <h1 className="truncate font-serif text-[26px] leading-tight">
                    Admin REIM
                  </h1>
                </div>
              </div>
            ...
            <div className="mt-4 grid grid-cols-[1.2fr_.8fr] gap-2">
              <div className="rounded-[22px] bg-white/10 px-4 py-3 ring-1 ring-white/10">
              ...
              <div className="rounded-[22px] bg-white/10 px-4 py-3 text-right ring-1 ring-white/10">
  ...
  return (
    <Link href={href}>
      <div
        className={
          dark
            ? 'relative flex min-h-[92px] flex-col items-center justify-center rounded-[24px] bg-[#151515] p-3 text-center text-white shadow-sm'
            : active
